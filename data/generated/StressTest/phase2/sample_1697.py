...
# Hypothesis: Jane is currently 82 years old, and she stopped baby-sitting 10 years ago.
...
if jane_age_premise != jane_age_hypothesis:
    # check if Jane's age in the hypothesis contradicts Jane's age in the premise
    label = "contradiction"
