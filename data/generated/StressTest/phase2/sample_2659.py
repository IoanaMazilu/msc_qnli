# Premise: In less than 65 years from now, Lyn the circus Lion will be exactly half as old as Ele, the circus Elephant.
# Hypothesis: In 15 years from now, Lyn the circus Lion will be exactly half as old as Ele, the circus Elephant.
