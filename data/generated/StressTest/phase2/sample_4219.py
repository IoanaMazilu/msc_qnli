# Premise: Aaron will jog from home at more than 4 miles per hour and then walk back home by the same route at 12 miles per hour.
# Hypothesis: Aaron will jog from home at 6 miles per hour and then walk back home by the same route at 12 miles per hour.
