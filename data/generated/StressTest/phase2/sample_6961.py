# Premise: Joe’s average (arithmetic mean) test score across more than 2 equally weighted tests was 60.
# Hypothesis: Joe’s average (arithmetic mean) test score across 4 equally weighted tests was 60.
