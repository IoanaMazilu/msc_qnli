# Premise: Joe’s average (arithmetic mean) test score across less than 6 equally weighted tests was 35.
# Hypothesis: Joe’s average (arithmetic mean) test score across 4 equally weighted tests was 35.
