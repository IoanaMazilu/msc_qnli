# Premise: Joe’s average (arithmetic mean) test score across less than 5 equally weighted tests was 40.
# Hypothesis: Joe’s average (arithmetic mean) test score across 4 equally weighted tests was 40.
