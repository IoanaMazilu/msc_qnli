# Premise: If less than 488 is divided into four parts proportional to 5, 7, 4, 8 then the smallest part is :
# Hypothesis: If 288 is divided into four parts proportional to 5, 7, 4, 8 then the smallest part is :
