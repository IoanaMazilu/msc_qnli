...
# Hypothesis: If the rosters for Professor Wang's less than 5 classes are combined with no student's name listed more than once, how many names will be on the combined roster?
