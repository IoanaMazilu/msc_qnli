# Premise: Shekar scored 76, 65, 82, 47 and 85 marks in Mathematics, Science, Social studies, English and Biology respectively.
# Hypothesis: Shekar scored more than 46, 65, 82, 47 and 85 marks in Mathematics, Science, Social studies, English and Biology respectively.
...
# the hypothesis refers to the marks scored in each subject by Shekar as mentioned in the premise
if math_marks_premise <= math_marks_hypothesis or science_marks_premise <= science_marks_hypothesis or social_studies_marks_premise <= social_studies_marks_hypothesis or english_marks_premise <= english_marks_hypothesis or biology_marks_premise <= biology_marks_hypothesis:
    # check if the marks in the hypothesis contradict the marks scored by Shekar in the premise
    label = "contradiction"
else:
