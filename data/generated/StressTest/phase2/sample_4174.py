# Premise: If KING is coded as less than 57 and MASS is coded as 29 Then COP is coded as.
# Hypothesis: If KING is coded as 17 and MASS is coded as 29 Then COP is coded as.
