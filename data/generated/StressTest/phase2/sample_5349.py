...
# Hypothesis: Sean, who weighs more than 100 pounds, is in the elevator with two packages weighing 150 pounds and 280 pounds.
...
if sean_weight_premise <= sean_weight_hypothesis:
    ...
    # check if the weight of the first package in the hypothesis contradicts the weight of the first package in the premise
    label = "contradiction"
elif package2_weight_premise != package2_weight_hypothesis:
    # check if the weight of the second package in the hypothesis contradicts the weight of the second package in the premise
    label = "contradiction"
else:
