# Premise: Suresh can complete a job in less than 85 hours.
# Hypothesis: Suresh can complete a job in 15 hours.
# Golden Label: neutral

job_completion_time_premise = 85
job_completion_time_hypothesis = 15

# the hypothesis talks about the time Suresh takes to complete a job, a topic also mentioned in the premise
