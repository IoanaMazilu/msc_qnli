...
# Hypothesis: In an exam, Amar scored more than 24 percent, Bhavan scored 36 percent and Chetan 44 percent.
...
if amar_score_premise <= amar_score_hypothesis:
    ...
    # if the hypothesis scores and estimates do not contradict the premise ones, we can infer entailment
    label = "entailment"
