# Premise: What will Sally have to sell each item for to generate a less than 85% profit?
# Hypothesis: What will Sally have to sell each item for to generate a 15% profit?
