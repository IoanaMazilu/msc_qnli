...
# the hypothesis refers to the scores of Amar, Bhavan and Chetan in an exam
if amar_score_hypothesis!= amar_score_premise:
    ...
    # if the scores of Amar, Bhavan and Chetan in the hypothesis do not contradict the scores in the premise, we can infer entailment
    label = "entailment"
