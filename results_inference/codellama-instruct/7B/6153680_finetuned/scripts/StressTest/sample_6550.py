...
if bird1_speed_hypothesis >= bird1_speed_premise:
    # check if the speed of the first bird in the hypothesis contradicts the speed mentioned in the premise
    label = "contradiction"
elif bird2_speed_hypothesis!= bird2_speed_premise:
    # check if the speed of the second bird in the hypothesis contradicts the speed mentioned in the premise
    label = "contradiction"
else:
