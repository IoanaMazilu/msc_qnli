...
# the hypothesis mentions the number of runs needed to avoid a defeat and the number of wickets left, which are also mentioned in the premise
if runs_needed_hypothesis!= runs_needed_premise:
    # check if the number of runs needed in the hypothesis contradicts the number of runs needed reported in the premise
    label = "contradiction"
