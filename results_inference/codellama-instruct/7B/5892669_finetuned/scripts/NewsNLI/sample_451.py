...
# the hypothesis mentions the number of animals and primates killed by law enforcement, which are also mentioned in the premise
if animals_killed_hypothesis!= animals_killed_premise:
    # check if the number of animals killed in the hypothesis contradicts the number of animals killed reported in the premise
    label = "contradiction"
