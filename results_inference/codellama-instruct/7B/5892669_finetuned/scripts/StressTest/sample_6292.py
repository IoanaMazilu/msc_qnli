...
# the hypothesis talks about the marks obtained by Arun in various subjects, referenced also in the premise
if english_marks_hypothesis <= english_marks_premise:
    ...
    # check if the marks in the other subjects in the hypothesis contradict the marks reported in the premise
    label = "contradiction"
else:
    # the premise gives only an estimate for the English marks
    # any English marks greater than 'english_marks_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
