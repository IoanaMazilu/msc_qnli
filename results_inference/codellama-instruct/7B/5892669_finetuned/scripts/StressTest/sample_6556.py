...
travel_england_italy_premise = 7
travel_france_italy_premise = 11

travel_england_france_hypothesis = 0
travel_england_italy_hypothesis = 6
travel_france_italy_hypothesis = 11

# the hypothesis refers to the number of club members who traveled to England, Italy, and France, mentioned in the premise
