...
# the hypothesis refers to the size of the group, the number of visitors to Iceland and Norway, all mentioned in the premise
if group_size_hypothesis <= group_size_premise:
    ...
    # any size of group greater than 'group_size_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
