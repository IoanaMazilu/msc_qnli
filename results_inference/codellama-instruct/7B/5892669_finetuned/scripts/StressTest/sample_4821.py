...
if balls_hypothesis <= balls_premise:
    # check if the estimate of 'balls_hypothesis' contradicts the number of balls bought in the premise
    label = "contradiction"
elif board_games_hypothesis!= board_games_premise:
    # check if the number of board games in the hypothesis contradicts the number of board games bought in the premise
    label = "contradiction"
else:
