...
# the hypothesis refers to the work hours of Mary on Monday, Wednesday, Friday, Tuesday and Thursday mentioned in the premise
if work_hours_mon_wed_fri_hypothesis!= work_hours_mon_wed_fri_premise:
    # check if the work hours on Monday, Wednesday, Friday in the hypothesis contradicts the work hours reported in the premise
    label = "contradiction"
