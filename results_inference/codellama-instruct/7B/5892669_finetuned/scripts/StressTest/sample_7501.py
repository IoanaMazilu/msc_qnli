...
# the hypothesis refers to the running speeds of Pat and Cara mentioned in the premise
if pat_speed_hypothesis <= pat_speed_premise:
    # check if the speed of Pat in the hypothesis contradicts the estimate of more than 'pat_speed_premise'
    label = "contradiction"
