...
if peanuts_box_hypothesis <= peanuts_box_premise:
    ...
    label = "contradiction"
elif peanuts_added_hypothesis!= peanuts_added:
    ...
    # any initial number of peanuts greater than 'peanuts_box_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
