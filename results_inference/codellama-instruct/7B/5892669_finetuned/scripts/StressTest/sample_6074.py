...
if first_travel_distance_premise!= first_travel_distance_hypothesis:
    # check if the distance of the first travel in the hypothesis contradicts the distance of the first travel in the premise
    label = "contradiction"
    ...
    # check if the distance of the second travel in the hypothesis contradicts the distance of the second travel in the premise
    label = "contradiction"
