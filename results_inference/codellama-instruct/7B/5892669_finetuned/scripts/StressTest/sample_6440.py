shifts_hours_premise = 10
shifts_hours_hypothesis = 70
...
if shifts_hours_hypothesis!= shifts_hours_premise:
    # check if the number of hours of shifts in the hypothesis contradicts the number of hours of shifts reported in the premise
    label = "contradiction"
