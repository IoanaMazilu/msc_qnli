...
# the hypothesis talks about the time Dawson takes to run the first leg of the course, referenced also in the premise
if first_leg_time_hypothesis <= first_leg_time_premise:
    ...
    # the premise gives only an estimate for the time Dawson takes to run the first leg
