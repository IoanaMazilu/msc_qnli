car_price_ratio_premise = 3
ac_price_ratio_premise = 2
car_price_ratio_hypothesis = 8
ac_price_ratio_hypothesis = 2

# the hypothesis refers to the ratio of the price of a car and AC mentioned in the premise
if car_price_ratio_premise!= car_price_ratio_hypothesis or ac_price_ratio_premise!= ac_price_ratio_hypothesis:
