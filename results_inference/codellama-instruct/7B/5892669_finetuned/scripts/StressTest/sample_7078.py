...
if paper_length_hypothesis <= paper_length_premise:
    # check if the length of the paper in the hypothesis contradicts the estimate of more than 'paper_length_premise'
    label = "contradiction"
    ...
    # any length of paper greater than 'paper_length_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
