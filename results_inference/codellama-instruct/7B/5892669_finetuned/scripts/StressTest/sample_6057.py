...
if anita_work_days_hypothesis <= anita_work_days_premise:
    ...
    # check if the number of days Indu can do the work in the hypothesis contradicts the number of days Indu can do the work reported in the premise
    label = "contradiction"
elif geeta_work_days_hypothesis!= geeta_work_days_premise:
    # check if the number of days Geeta can do the work in the hypothesis contradicts the number of days Geeta can do the work reported in the premise
    label = "contradiction"
else:
