...
if year_hypothesis >= year_premise:
    ...
    # any year less than 'year_premise' and any number of passengers equal to 'passengers_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
