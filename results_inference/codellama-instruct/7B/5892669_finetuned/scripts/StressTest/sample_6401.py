...
if miami_kennedy_ratio_premise!= miami_kennedy_ratio_hypothesis:
    # check if the ratio of passengers using Miami to Kennedy airports in the hypothesis contradicts the ratio in the premise
    label = "contradiction"
elif miami_logan_ratio_premise!= miami_logan_ratio_hypothesis:
    # check if the ratio of passengers using Miami to Logan airports in the hypothesis contradicts the ratio in the premise
    label = "contradiction"
else:
