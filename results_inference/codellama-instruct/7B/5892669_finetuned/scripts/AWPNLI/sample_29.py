...
# the hypothesis refers to the number of pennies Sam has now, which can be calculated from the premise
# compute the number of pennies Sam has now in the premise
