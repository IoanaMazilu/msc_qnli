...
stones_each_bracelet_premise = 8.0
...
# compute the total number of bracelets Shannon can make in the premise
bracelets_premise = stones_brought_premise / stones_each_bracelet_premise
