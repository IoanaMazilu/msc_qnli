...
students_left_bus_hypothesis = 7.0
...
students_left_bus_premise = students_on_bus_premise - students_off_bus_premise
if students_left_bus_hypothesis!= students_left_bus_premise:
