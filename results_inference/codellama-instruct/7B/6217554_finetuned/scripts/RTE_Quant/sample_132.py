...
if gold_medals_hypothesis!= gold_medals_premise:
    # check if the number of gold medals won by Carl Lewis in the hypothesis contradicts the number of gold medals from the premise
    label = "contradiction"
elif world_records_hypothesis!= world_records_premise:
    # check if the number of world records set by Carl Lewis in the hypothesis contradicts the number of world records from the premise
    label = "contradiction"
else:
