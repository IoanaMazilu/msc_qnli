...
grapes_kg_rate_premise = 68
grapes_kg_rate_hypothesis = 68
mangoes_kg_premise = 9
mangoes_kg_hypothesis = 9
mangoes_kg_rate_premise = 48
mangoes_kg_rate_hypothesis = 48

# the hypothesis refers to the number of kg of grapes and mangoes purchased, as well as their rates, mentioned in the premise
if grapes_kg_hypothesis >= grapes_kg_premise:
    # check if the number of kg of grapes in the hypothesis contradicts the number of kg of grapes reported in the premise
    label = "contradiction"
elif grapes_kg_rate_hypothesis!= grapes_kg_rate_premise:
    ...
    label = "contradiction"
elif mangoes_kg_rate_hypothesis!= mangoes_kg_rate_premise:
