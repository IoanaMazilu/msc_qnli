...
total_passengers_premise = 32.3
total_passengers_hypothesis = 32.3

# the hypothesis refers to the number of passengers in a specific year and the total number of passengers
