...
# the hypothesis refers to the number of shirts, jeans and sneakers in an outfit, referenced also in the premise
if shirts_outfit_hypothesis!= shirts_outfit_premise:
    ...
    label = "contradiction"
elif jeans_outfit_hypothesis!= jeans_outfit_premise:
    # check if the number of jeans in the hypothesis contradicts the number of jeans reported in the premise
    label = "contradiction"
elif sneakers_outfit_hypothesis!= sneakers_outfit_premise:
