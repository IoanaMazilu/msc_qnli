...
# the hypothesis refers to the total number of lemon heads eaten, which is also mentioned in the premise
...
if total_lemon_heads_hypothesis!= total_lemon_heads_premise:
    # check if the number of lemon heads eaten in the hypothesis contradicts the number of lemon heads eaten in the premise
    label = "contradiction"
else:
