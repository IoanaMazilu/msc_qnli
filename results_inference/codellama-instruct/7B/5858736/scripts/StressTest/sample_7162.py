...
if red_bricks_hypothesis <= red_bricks_premise:
    ...
    # check if the hypothesis value contradicts the estimate of more than 'green_bricks_premise'
    label = "contradiction"
elif blue_bricks_hypothesis <= blue_bricks_premise:
    # check if the hypothesis value contradicts the estimate of more than 'blue_bricks_premise'
    label = "contradiction"
else:
