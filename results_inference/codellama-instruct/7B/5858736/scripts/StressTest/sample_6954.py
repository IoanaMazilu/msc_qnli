...
if shirts_salman_hypothesis <= shirts_salman_premise:
    ...
    # the premise gives only an estimate for the number of shirts with Salman, Ambani and Dalmiya
    # any number of shirts greater than'shirts_salman_premise','shirts_ambani_premise' and'shirts_dalmiya_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
