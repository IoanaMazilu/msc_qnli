animals_killed_law_enforcement_premise = 48
animals_killed_law_enforcement_hypothesis = 48
primates_killed_other_animals_premise = 2
primates_killed_other_animals_hypothesis = 2
...
if animals_killed_law_enforcement_hypothesis!= animals_killed_law_enforcement_premise:
    ...
    label = "contradiction"
elif primates_killed_other_animals_hypothesis!= primates_killed_other_animals_premise:
