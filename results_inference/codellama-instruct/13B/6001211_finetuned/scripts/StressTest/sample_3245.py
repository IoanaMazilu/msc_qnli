...
if consumable_items_hypothesis >= consumable_items_premise:
    ...
    # check if the percentage spent on clothes and transport in the hypothesis contradicts the percentage spent on clothes and transport reported in the premise
    label = "contradiction"
else:
