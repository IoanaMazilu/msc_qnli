...
if ramesh_work_days_hypothesis >= ramesh_work_days_premise:
    # check if the number of days Ramesh can finish a work in the hypothesis contradicts the estimate of less than 'ramesh_work_days_premise'
    label = "contradiction"
elif sushil_work_days_hypothesis!= sushil_work_days_premise:
    # check if the number of days Sushil can finish a work in the hypothesis contradicts the number of days Sushil can finish a work in the premise
    label = "contradiction"
else:
