...
if priya_ratio_hypothesis >= priya_ratio_premise:
    # check if the estimate of 'priya_ratio_hypothesis' contradicts the ratio of Priya's share in the premise
    label = "contradiction"
elif mani_ratio_hypothesis!= mani_ratio_premise or rani_ratio_hypothesis!= rani_ratio_premise:
    # check if the ratio of Mani's or Rani's share in the hypothesis contradicts the ratio of Mani's or Rani's share reported in the premise
    label = "contradiction"
else:
