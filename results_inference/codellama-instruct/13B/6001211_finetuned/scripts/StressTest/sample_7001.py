...
if ramesh_work_days_hypothesis <= ramesh_work_days_premise:
    # check if the estimate of 'ramesh_work_days_hypothesis' contradicts the number of work days for Ramesh in the premise
    label = "contradiction"
elif sushil_work_days_hypothesis!= sushil_work_days_premise:
    # check if the number of work days for Sushil in the hypothesis contradicts the number of work days reported for Sushil in the premise
    label = "contradiction"
else:
