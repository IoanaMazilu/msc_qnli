...
if jack_time_hypothesis <= jack_time_premise:
    # check if the time Jack takes in the hypothesis contradicts the estimate of more than 'jack_time_premise'
    label = "contradiction"
    ...
    # the premise gives only an estimate for the time Jack takes
