...
if math_marks_hypothesis <= math_marks_premise:
    # check if the marks in Mathematics in the hypothesis contradict the estimate of more than'math_marks_premise'
    label = "contradiction"
    ...
    # any marks in Mathematics greater than'math_marks_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
