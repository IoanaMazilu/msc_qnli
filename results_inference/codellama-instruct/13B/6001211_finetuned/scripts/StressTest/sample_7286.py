...
# the hypothesis refers to the salaries and commission of the jobs mentioned in the premise
if old_job_salary_premise!= old_job_salary_hypothesis:
    ...
    # check if the new job commission percentage in the hypothesis contradicts the new job commission percentage reported in the premise
    label = "contradiction"
else:
