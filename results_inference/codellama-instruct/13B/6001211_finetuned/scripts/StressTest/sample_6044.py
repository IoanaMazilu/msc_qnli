...
if distance_premise!= distance_hypothesis:
    ...
    # check if Maxwell's walking speed in the hypothesis contradicts Maxwell's walking speed in the premise
    label = "contradiction"
elif brad_speed_premise!= brad_speed_hypothesis:
    # check if Brad's running speed in the hypothesis contradicts Brad's running speed in the premise
    label = "contradiction"
else:
