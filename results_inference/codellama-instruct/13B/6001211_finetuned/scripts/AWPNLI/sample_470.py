...
# the hypothesis refers to the total number of hamburgers made in the restaurant, which is also mentioned in the premise
...
if hamburgers_made_hypothesis!= total_hamburgers_premise:
