...
total_left_bottles_premise = total_bottles_premise - drank_bottles_premise - sister_drank_bottles_premise
if left_bottles_hypothesis!= total_left_bottles_premise:
