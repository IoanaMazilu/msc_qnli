...
# the hypothesis refers to the number of buses needed, which can be calculated from the premise
...
if buses_hypothesis!= total_buses_premise:
    # check if the number of buses in the hypothesis contradicts the number of buses calculated from the premise
    label = "contradiction"
else:
