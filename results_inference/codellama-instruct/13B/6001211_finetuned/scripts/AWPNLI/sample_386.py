...
pears_mike_left_premise = pears_mike_premise - pears_given_premise
if pears_mike_hypothesis!= pears_mike_left_premise:
    # check if the number of pears Mike has in the hypothesis contradicts the number of pears he has left from the premise
    label = "contradiction"
else:
