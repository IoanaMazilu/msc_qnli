...
if hypothesis_tip_rate <= premise_tip_rate:
    ...
    # any value of tip rate greater than 'premise_tip_rate' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
