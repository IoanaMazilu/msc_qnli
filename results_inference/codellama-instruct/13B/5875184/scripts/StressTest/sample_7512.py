...
if shirt_outfit_hypothesis <= shirt_outfit_premise:
    ...
    # the premise gives an exact number of shirts in an outfit
    # any number of shirts greater than or equal to'shirt_outfit_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
