...
# the hypothesis refers to the difference between Mani and Rani's share, which is not mentioned in the premise
if mani_share_hypothesis <= mani_share_premise:
    ...
    # any difference greater than'mani_share_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
