...
if oa_hypothesis >= oa_premise:
    ...
    # check if the value of AC in the hypothesis contradicts the value of AC reported in the premise
    label = "contradiction"
elif bd_hypothesis!= bd_premise:
    # check if the value of BD in the hypothesis contradicts the value of BD reported in the premise
    label = "contradiction"
else:
