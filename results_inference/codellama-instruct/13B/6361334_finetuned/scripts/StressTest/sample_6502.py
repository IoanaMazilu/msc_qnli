...
if matthew_walking_rate_hypothesis >= matthew_walking_rate_premise:
    # check if the estimate of'matthew_walking_rate_hypothesis' contradicts the number of km walked by Matthew in the premise
    label = "contradiction"
elif johnny_walking_rate_hypothesis!= johnny_walking_rate_premise:
    # check if the number of km walked by Johnny in the hypothesis contradicts the number of km walked by Johnny reported in the premise
    label = "contradiction"
else:
