...
# the premise mentions a decrease less than 80%
if saving_amount_hypothesis >= saving_amount_premise:
    ...
    # any percentage of saving amount decreased less than'saving_amount_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
