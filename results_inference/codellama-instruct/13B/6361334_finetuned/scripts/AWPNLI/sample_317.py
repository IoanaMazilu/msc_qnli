...
total_students_premise = num_students_premise / num_students_per_classroom_premise
if total_students_premise!= num_classrooms_hypothesis * num_students_per_classroom_premise:
