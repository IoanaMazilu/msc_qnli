...
# the hypothesis mentions the developer and the number of apps kicked out, which are also mentioned in the premise
if developer_hypothesis!= developer_premise:
    # check if the developer in the hypothesis contradicts the developer mentioned in the premise
    label = "contradiction"
