...
# the hypothesis refers to the total number of slices, which are also mentioned in the premise
...
if total_slices_hypothesis!= total_slices_premise:
    # check if the number of slices in the hypothesis contradicts the number of slices from the premise
    label = "contradiction"
else:
