...
# the hypothesis talks about the shop offer for every shirt, referenced also in the premise
if shop_offer_hypothesis <= shop_offer_premise:
    # check if the hypothesis value contradicts the estimate of more than'shop_offer_premise'
    label = "contradiction"
else:
