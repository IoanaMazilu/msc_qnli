...
if hypothesis_owners <= premise_owners:
    ...
    # any number of people greater than 'premise_owners' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
