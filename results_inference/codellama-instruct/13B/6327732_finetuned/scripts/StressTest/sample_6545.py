...
if father_age_hypothesis <= father_age_premise:
    ...
    # check if the age of Ayesha's mother in the hypothesis contradicts the age of Ayesha's mother reported in the premise
    label = "contradiction"
elif brother_age_hypothesis!= brother_age_premise:
    # check if the age of Ayesha's brother in the hypothesis contradicts the age of Ayesha's brother reported in the premise
    label = "contradiction"
else:
