...
if lewis_age_hypothesis <= lewis_age_premise and brown_age_hypothesis <= brown_age_premise:
    ...
    # any ratio of the ages greater than 'lewis_age_premise' and 'brown_age_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
