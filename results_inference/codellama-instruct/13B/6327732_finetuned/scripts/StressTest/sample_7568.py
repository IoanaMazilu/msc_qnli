...
if shifts_premise!= shifts_hypothesis or hours_per_shift_premise!= hours_per_shift_hypothesis:
    # check if the hypothesis values contradict the premise values
    label = "contradiction"
elif orders_per_hour_hypothesis!= orders_per_hour_premise:
    # check if the hypothesis value for orders per hour contradicts the premise value
    label = "contradiction"
else:
