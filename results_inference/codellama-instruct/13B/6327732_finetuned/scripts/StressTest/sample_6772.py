...
if city_a_to_b_speed_hypothesis > city_a_to_b_speed_premise:
    # check if the hypothesis value contradicts the estimate of less than 'city_a_to_b_speed_premise'
    label = "contradiction"
elif city_b_to_c_speed_hypothesis!= city_b_to_c_speed_premise:
    # check if the speed of travel from city B to city C in the hypothesis contradicts the speed of travel mentioned in the premise
    label = "contradiction"
else:
