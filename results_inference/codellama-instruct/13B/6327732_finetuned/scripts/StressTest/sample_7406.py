...
if lenses_per_telescope_hypothesis <= lenses_per_telescope_premise:
    # check if the hypothesis value contradicts the estimate of 'lenses_per_telescope_premise'
    label = "contradiction"
else:
    # the premise gives only an estimate for the number of lenses per telescope
