...
if city_a_to_city_b_hypothesis <= city_a_to_city_b_premise:
    ...
    # any total time taken by Andrew to drive from city A to city B greater than 'city_a_to_city_b_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
