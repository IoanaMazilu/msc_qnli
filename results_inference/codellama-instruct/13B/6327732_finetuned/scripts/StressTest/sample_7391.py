...
# the hypothesis talks about the efficiency of Rosy compared to Mary
if efficiency_hypothesis >= efficiency_premise:
    ...
    # any value of efficiency less than 'efficiency_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
