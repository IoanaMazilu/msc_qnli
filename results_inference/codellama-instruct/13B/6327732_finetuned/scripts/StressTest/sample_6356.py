...
if hypothesis_microtron_price!= premise_microtron_price:
    # check if the hypothesis value contradicts the premise value for the MicroTron stock price
    label = "contradiction"
elif hypothesis_dynaco_price!= premise_dynaco_price:
    # check if the hypothesis value contradicts the premise value for the Dynaco stock price
    label = "contradiction"
