...
if red_bricks_hypothesis <= red_bricks_premise and green_bricks_hypothesis <= green_bricks_premise and blue_bricks_hypothesis <= blue_bricks_premise:
    ...
    # the premise gives an exact ratio of red, green, and blue bricks used in the tower
    # any ratio of bricks greater than the premise ones is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
