...
if hypothesis_saving_amount < premise_saving_amount:
    ...
    # any percentage less than 'premise_saving_amount' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
