...
if team_points_hypothesis >= team_points_premise:
    # check if the hypothesis value contradicts the estimate of less than 'team_points_premise'
    label = "contradiction"
elif jason_percentage_hypothesis!= jason_percentage_premise:
    # check if the percentage of points accounted for by Jason in the hypothesis contradicts the percentage mentioned in the premise
    label = "contradiction"
else:
