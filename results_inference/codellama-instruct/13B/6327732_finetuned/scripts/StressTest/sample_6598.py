efrida_frazer_distance_premise = 35
efrida_frazer_distance_hypothesis = 15
...
if efrida_frazer_distance_hypothesis >= efrida_frazer_distance_premise:
    # check if the hypothesis value contradicts the estimate of less than 'efrida_frazer_distance_premise'
    label = "contradiction"
else:
