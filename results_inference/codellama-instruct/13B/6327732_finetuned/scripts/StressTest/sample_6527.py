...
premise_airport_ontime_departure_rate = 60
hypothesis_airport_ontime_departure_rate = 20
...
if premise_flights_departed_ontime!= hypothesis_flights_departed_ontime:
