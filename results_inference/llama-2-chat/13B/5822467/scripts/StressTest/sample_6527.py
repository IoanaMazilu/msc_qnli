...
on_time_rate_premise = 60
on_time_rate_hypothesis = 20
...
if flights_hypothesis <= on_time_rate_premise:
    # check if the estimate of 'on_time_rate_hypothesis' contradicts the on-time departure rate reported in the premise
    label = "contradiction"
