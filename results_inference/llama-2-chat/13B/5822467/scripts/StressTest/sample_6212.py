...
# the hypothesis refers to the number of employees and the length of the highway, both mentioned in the premise
if nhai_employees_hypothesis <= nhai_employees_premise:
    # check if the estimate of 'nhai_employees_hypothesis' contradicts the number of employees reported in the premise
    label = "contradiction"
