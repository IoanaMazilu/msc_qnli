...
tip_rate_premise = 0.8 * 10.00
tip_rate_hypothesis = 0.4 * 10.00
...
if hourly_wage_premise <= hourly_wage_hypothesis:
    ...
    # check if the standard tip rate in the hypothesis contradicts the standard tip rate reported in the premise
    label = "contradiction"
else:
