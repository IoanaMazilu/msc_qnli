...
petrol_hypothesis = 0.3 * income_hypothesis  # calculate the percentage of income spent on petrol in the hypothesis
house_rent_premise = 0.12 * (1 - petrol_premise)  # calculate the percentage of income spent on house rent in the premise
house_rent_hypothesis = 0.12 * (1 - petrol_hypothesis)  # calculate the percentage of income spent on house rent in the hypothesis
