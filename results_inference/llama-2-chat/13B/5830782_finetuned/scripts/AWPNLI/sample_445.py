...
# compute the number of bathing suits for men in the premise by subtracting the number of bathing suits for women from the total number of bathing suits
