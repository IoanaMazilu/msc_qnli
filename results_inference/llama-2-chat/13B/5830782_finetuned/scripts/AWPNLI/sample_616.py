...
# the hypothesis refers to the number of pots, which can be calculated from the premise
...
if pots_hypothesis!= total_pots_premise:
    # check if the number of pots in the hypothesis contradicts the number of pots calculated from the premise
    label = "contradiction"
else:
