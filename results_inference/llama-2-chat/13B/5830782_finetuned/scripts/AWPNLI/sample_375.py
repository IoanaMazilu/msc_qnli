...
# compute the total number of cakes left in the premise
total_cakes_left_premise = baked_cakes_lunch_premise - sold_cakes_dinner_premise + baked_cakes_yesterday_premise
if left_cakes_hypothesis!= total_cakes_left_premise:
