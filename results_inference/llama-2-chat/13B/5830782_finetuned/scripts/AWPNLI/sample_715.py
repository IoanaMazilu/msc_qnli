...
# the hypothesis refers to the total number of papers given, which can be calculated from the premise
...
if total_papers_given_hypothesis!= total_papers_given_premise:
    # check if the total number of papers given in the hypothesis contradicts the total number of papers given from the premise
    label = "contradiction"
else:
