...
gamble_dollars_premise = 6 * (allowance_dollars_premise + saved_dollars_premise)
...
total_dollars_premise = saved_dollars_premise + allowance_dollars_premise + gamble_dollars_premise
