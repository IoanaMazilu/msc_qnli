...
# the hypothesis talks about the units digits of Sophie Germain primes, referenced also in the premise
if units_digits_hypothesis <= units_digits_premise:
    ...
    # any units digits greater than 'units_digits_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
