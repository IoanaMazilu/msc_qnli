...
if distance_premise > distance_hypothesis:
    ...
    # check if the walking speed of Maxwell in the hypothesis contradicts the walking speed of Maxwell reported in the premise
    label = "contradiction"
elif brad_speed_premise!= brad_speed_hypothesis:
    # check if the running speed of Brad in the hypothesis contradicts the running speed of Brad reported in the premise
    label = "contradiction"
else:
