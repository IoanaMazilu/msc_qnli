...
if boys_age14_premise <= boys_age14_hypothesis:
    # check if the estimate of 'boys_age14_hypothesis' contradicts the number of boys age 14 in the premise
    label = "contradiction"
elif boys_age15_hypothesis!= boys_age15_premise:
    # check if the number of boys age 15 in the hypothesis contradicts the number of boys age 15 reported in the premise
    label = "contradiction"
elif boys_age13_hypothesis!= boys_age13_premise:
    # check if the number of boys age 13 in the hypothesis contradicts the number of boys age 13 reported in the premise
    label = "contradiction"
elif boys_age12_hypothesis!= boys_age12_premise:
    # check if the number of boys age 12 in the hypothesis contradicts the number of boys age 12 reported in the premise
    label = "contradiction"
else:
