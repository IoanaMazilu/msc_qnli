...
if first_leg_distance_premise!= first_leg_distance_hypothesis:
    # check if the distance of the first driving leg in the hypothesis contradicts the distance reported in the premise
    label = "contradiction"
elif second_leg_distance_premise!= second_leg_distance_hypothesis:
    # check if the distance of the second driving leg in the hypothesis contradicts the distance reported in the premise
    label = "contradiction"
elif first_leg_speed_premise!= first_leg_speed_hypothesis:
    # check if the speed of the first driving leg in the hypothesis contradicts the speed reported in the premise
    label = "contradiction"
elif second_leg_speed_premise!= second_leg_speed_hypothesis:
    # check if the speed of the second driving leg in the hypothesis contradicts the speed reported in the premise
    label = "contradiction"
else:
