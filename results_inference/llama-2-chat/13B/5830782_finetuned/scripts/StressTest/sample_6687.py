...
# the hypothesis refers to the number of books purchased, including hardback and paperback, mentioned in the premise
if total_books_purchased_premise <= total_books_purchased_hypothesis:
    # check if the estimate of 'total_books_purchased_hypothesis' contradicts the number of books purchased in the premise
    label = "contradiction"
elif hardback_books_premise!= hardback_books_hypothesis:
    # check if the number of hardback books in the hypothesis contradicts the number of hardback books reported in the premise
    label = "contradiction"
elif paperback_books_premise!= paperback_books_hypothesis:
