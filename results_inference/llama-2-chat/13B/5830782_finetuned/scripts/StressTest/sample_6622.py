...
# the hypothesis talks about the size of the committees and the number of people, referenced also in the premise
if committee_size_hypothesis >= committee_size_premise:
    # check if the committee size in the hypothesis contradicts the premise of less than 'committee_size_premise'
    label = "contradiction"
