...
if french_score_hypothesis <= french_score_premise:
    ...
    label = "contradiction"
elif geography_score_hypothesis!= geography_score_premise or art_design_score_hypothesis!= art_design_score_premise or history_score_hypothesis!= history_score_premise or physical_education_score_hypothesis!= physical_education_score_premise:
    # check if the scores in Geography, Art and design, History and Physical Education in the hypothesis contradict the scores reported in the premise
    label = "contradiction"
else:
