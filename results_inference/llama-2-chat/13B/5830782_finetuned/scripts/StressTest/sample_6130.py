hours_week_premise = 11
hours_week_hypothesis = 21

# the hypothesis talks about the hours Harry is paid x dollars per hour for the first hours, referenced also in the premise
