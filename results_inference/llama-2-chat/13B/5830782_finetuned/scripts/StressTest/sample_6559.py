...
# the hypothesis talks about the number of tests and their average score, referenced also in the premise
if tests_hypothesis >= tests_premise:
    # check if the hypothesis value contradicts the estimate of less than 'tests_premise'
    label = "contradiction"
