...
if password_digits_hypothesis == password_digits_premise:
    ...
    label = "contradiction"
elif password_digits_hypothesis < password_digits_premise:
    # check if the number of digits in the hypothesis is less than the number of digits reported in the premise
    label = "contradiction"
else:
