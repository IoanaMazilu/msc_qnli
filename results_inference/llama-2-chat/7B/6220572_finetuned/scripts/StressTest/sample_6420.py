...
if marks_english_hypothesis >= marks_english_premise or \
   marks_mathematics_hypothesis >= marks_mathematics_premise or \
   marks_chemistry_hypothesis >= marks_chemistry_premise or \
   marks_biology_hypothesis >= marks_biology_premise or \
   marks_physics_hypothesis >= marks_physics_premise:
