...
# the hypothesis refers to the distance between homes, Maxwell's and Brad's speeds, and the distance traveled by Brad mentioned in the premise
if distance_hypothesis <= distance_premise:
    # check if the estimate of 'distance_hypothesis' contradicts the distance between homes in the premise
    label = "contradiction"
