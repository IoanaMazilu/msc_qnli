...
# the hypothesis refers to the ratio between Rahul and Deepak and Rahul's age mentioned in the premise
if ratio_hypothesis <= ratio_premise:
    # check if the hypothesis value contradicts the ratio in the premise
    label = "contradiction"
elif rahul_age_hypothesis!= rahul_age_premise:
    # check if the hypothesis value contradicts the Rahul's age in the premise
    label = "contradiction"
else:
