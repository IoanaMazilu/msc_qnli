...
# the hypothesis refers to the number of students studying different topics at the faculty, mentioned also in the premise
if students_random_hypothesis <= students_random_premise:
    ...
    # check if the number of students studying both topics in the hypothesis contradicts the number of students reported in the premise
    label = "contradiction"
else:
