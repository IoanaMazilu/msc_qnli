...
if sophie_germain_prime_hypothesis <= sophie_germain_prime_premise:
    ...
    # any number of Sophie Germain primes greater than'sophie_germain_prime_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
