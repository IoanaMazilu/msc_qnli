work_days_premise = 18
work_days_hypothesis = 58

# the hypothesis talks about the number of days for which Anita, Indu, and Geeta can do a piece of work, as mentioned in the premise
