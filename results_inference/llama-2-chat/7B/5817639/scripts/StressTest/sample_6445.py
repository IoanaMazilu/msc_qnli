...
# the hypothesis talks about the age difference between two individuals, referenced also in the premise
if frank_age_hypothesis <= frank_age_premise:
    # check if the hypothesis value contradicts the estimate of less than 'frank_age_premise'
    label = "contradiction"
else:
