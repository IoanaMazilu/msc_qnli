...
# the hypothesis talks about the number of hours worked and the average orders per hour, which are also mentioned in the premise
if orders_per_hour_hypothesis <= orders_per_hour_premise:
    ...
    # any number of hours worked and average orders per hour consistent with the premise is neutral, but cannot be explicitly entailed from the premise
    label = "neutral"
