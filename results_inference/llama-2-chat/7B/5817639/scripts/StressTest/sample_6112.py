level_1_employees_premise = 60
level_1_employees_hypothesis = 80
...
if level_1_employees_hypothesis <= level_1_employees_premise:
    # check if the estimate of 'level_1_employees_hypothesis' contradicts the number of level-1 employees in the premise
    label = "contradiction"
