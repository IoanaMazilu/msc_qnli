...
hypothesis_pink_highlighters = 7
hypothesis_yellow_highlighters = 8
hypothesis_blue_highlighters = 5

# the hypothesis talks about the number of highlighters in Kaya's teacher's desk
if hypothesis_pink_highlighters <= pink_highlighters_premise:
    # check if the hypothesis value contradicts the estimate of 'pink_highlighters_premise'
    label = "contradiction"
