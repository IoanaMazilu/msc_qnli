...
if carolyn_gumballs_hypothesis!= carolyn_gumballs_premise:
    # check if the number of gumballs bought by Carolyn in the hypothesis contradicts the number in the premise
    label = "contradiction"
elif lew_gumballs_hypothesis!= lew_gumballs_premise:
    # check if the number of gumballs bought by Lew in the hypothesis contradicts the number in the premise
    label = "contradiction"
elif carey_gumballs_hypothesis!= carey_gumballs_premise:
    # check if the number of gumballs bought by Carey in the hypothesis contradicts the number in the premise
    label = "contradiction"
else:
