...
tip_rate_premise = 15 / 100
tip_rate_hypothesis = 65 / 100

# the hypothesis refers to the hourly wage and tip rate of Jill, which are also mentioned in the premise
