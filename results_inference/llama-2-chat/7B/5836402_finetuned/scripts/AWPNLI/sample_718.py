...
people_friday_times_saturday_premise = 3
...
# compute the number of people who visited the zoo on Saturday from the premise
people_saturday_premise = people_friday_premise * people_friday_times_saturday_premise
