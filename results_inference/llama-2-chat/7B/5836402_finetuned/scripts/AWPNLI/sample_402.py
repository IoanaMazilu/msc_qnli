...
# the hypothesis refers to the number of pears, which are also mentioned in the premise
...
if left_pears_hypothesis!= left_pears_premise:
    # check if the number of pears left in the hypothesis contradicts the number of pears from the premise
    label = "contradiction"
else:
