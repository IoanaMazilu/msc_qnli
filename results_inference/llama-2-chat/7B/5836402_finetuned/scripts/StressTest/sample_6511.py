...
# the hypothesis refers to the number of digits in X, Y and Z, and the possible product, which is also mentioned in the premise
if digits_hypothesis <= digits_premise:
    # check if the hypothesis value contradicts the estimate of more than 'digits_premise'
    label = "contradiction"
else:
