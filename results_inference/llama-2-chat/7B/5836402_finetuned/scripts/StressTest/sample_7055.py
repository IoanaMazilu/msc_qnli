...
# the hypothesis refers to the scores of Amar, Bhavan and Chetan in the premise
if amar_score_hypothesis!= amar_score_premise:
    # check if the score of Amar in the hypothesis contradicts the score reported in the premise
    label = "contradiction"
