...
# the hypothesis refers to the same income spending percentages and the remaining income as the premise
if income_spent_petrol_premise <= income_spent_petrol_hypothesis:
    ...
    # check if the remaining income in the hypothesis contradicts the remaining income reported in the premise
    label = "contradiction"
else:
