...
floor_elevator_hypothesis = 61
elevator_speed_premise = 57
elevator_speed_hypothesis = 57

# the hypothesis refers to the floor of the building David gets on and the speed of the elevator
if floor_elevator_hypothesis >= floor_elevator_premise:
    # check if the estimate of 'floor_elevator_hypothesis' contradicts the floor of the building mentioned in the premise
    label = "contradiction"
