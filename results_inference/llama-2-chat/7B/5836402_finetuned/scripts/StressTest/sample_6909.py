...
# the hypothesis refers to the age difference and the age ratio between Roshan and Raj mentioned in the premise
if roshan_age_difference_hypothesis >= roshan_age_difference_premise:
    # check if the estimate of 'roshan_age_difference_hypothesis' contradicts the number of 'roshan_age_difference_premise'
    label = "contradiction"
