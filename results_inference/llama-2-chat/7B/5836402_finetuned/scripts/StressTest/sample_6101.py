...
# the hypothesis refers to the number of days Mary will take to complete a task, also mentioned in the premise
if days_task_hypothesis <= days_task_premise:
    # check if the hypothesis value contradicts the estimate of more than 'days_task_premise'
    label = "contradiction"
else:
