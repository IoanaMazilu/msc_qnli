...
# the hypothesis refers to the fuel capacity of the aircraft, which is also mentioned in the premise
if fuel_tank_capacity_hypothesis < fuel_tank_capacity_premise:
    # check if the estimate of 'fuel_tank_capacity_hypothesis' contradicts the fuel capacity in the premise
    label = "contradiction"
