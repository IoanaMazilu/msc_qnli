...
eaten_candy_first_night_premise = 25.0
received_candy_from_sister_premise = 40.0
...
total_candy_premise = initial_candy_premise - eaten_candy_first_night_premise + received_candy_from_sister_premise
