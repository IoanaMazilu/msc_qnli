...
birds_sitting_premise = birds_initial_premise - birds_flew_away_premise
if birds_sitting_hypothesis!= birds_sitting_premise:
    # check if the number of birds sitting on the fence in the hypothesis contradicts the number from the premise
    label = "contradiction"
else:
