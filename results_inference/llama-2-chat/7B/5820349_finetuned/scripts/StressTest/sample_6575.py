...
if vikas_rank_hypothesis <= vikas_rank_premise:
    ...
    # check if the rank of Vikas from the bottom in the hypothesis contradicts the rank of Vikas from the bottom in the premise
    label = "contradiction"
elif tanvi_rank_top_hypothesis!= tanvi_rank_top_premise:
    # check if the rank of Tanvi from the top in the hypothesis contradicts the rank of Tanvi from the top in the premise
    label = "contradiction"
elif tanvi_rank_bottom_hypothesis!= tanvi_rank_bottom_premise:
    # check if the rank of Tanvi from the bottom in the hypothesis contradicts the rank of Tanvi from the bottom in the premise
    label = "contradiction"
else:
