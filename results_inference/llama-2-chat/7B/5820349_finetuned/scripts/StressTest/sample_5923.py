...
# the hypothesis refers to the duration of the trip home compared to the trip to the beach, also mentioned in the premise
if trip_home_hypothesis >= trip_home_premise:
    # check if the hypothesis value contradicts the premise estimate of less than 'trip_home_premise'
    label = "contradiction"
else:
