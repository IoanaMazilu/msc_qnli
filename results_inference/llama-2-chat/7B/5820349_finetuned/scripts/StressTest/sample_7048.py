...
# the hypothesis talks about the percentage below cost price at which Vijay sells a cupboard
if below_cost_price_hypothesis >= below_cost_price_premise:
    ...
    # any percentage below cost price less than 'below_cost_price_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
