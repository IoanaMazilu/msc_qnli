...
# the hypothesis refers to the exam scores of Bobby, Bonny, Vijay and Libin mentioned in the premise
if bobby_score_hypothesis!= bobby_score_premise:
    ...
    # check if Bonny's score in the hypothesis contradicts his score in the premise
    label = "contradiction"
