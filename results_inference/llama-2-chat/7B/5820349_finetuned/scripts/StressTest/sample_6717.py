...
if aaron_jellybeans_hypothesis <= aaron_jellybeans_premise:
    # check if the estimate of 'aaron_jellybeans_hypothesis' contradicts the number of jelly beans Aaron has in the premise
    label = "contradiction"
    ...
    # check if the number of jelly beans each child has in the hypothesis contradicts the number of jelly beans each child has in the premise
    label = "contradiction"
else:
