...
# the hypothesis refers to the number of each type of animal James have, which is also mentioned in the premise
if parrots_hypothesis >= parrots_premise:
    # check if the number of parrots in the hypothesis contradicts the premise estimate of less than 'parrots_premise'
    label = "contradiction"
elif fishes_hypothesis!= fishes_premise or rabbits_hypothesis!= rabbits_premise or dogs_hypothesis!= dogs_premise:
    # check if the number of fishes, rabbits or dogs in the hypothesis contradicts the number of each type of animal reported in the premise
    label = "contradiction"
else:
