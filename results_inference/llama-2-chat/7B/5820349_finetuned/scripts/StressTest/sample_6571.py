...
# the hypothesis refers to the rank of Vikas and Tanvi mentioned in the premise
if vikas_rank_hypothesis <= vikas_rank_premise:
    # check if the rank of Vikas in the hypothesis contradicts the rank of Vikas in the premise
    label = "contradiction"
