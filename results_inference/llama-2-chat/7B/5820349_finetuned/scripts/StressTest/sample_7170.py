...
if problems_start_hypothesis > problems_start_premise:
    # check if the start of problem range in the hypothesis contradicts the start of problem range in the premise
    label = "contradiction"
elif problems_end_hypothesis!= problems_end_premise:
    # check if the end of problem range in the hypothesis contradicts the end of problem range in the premise
    label = "contradiction"
else:
