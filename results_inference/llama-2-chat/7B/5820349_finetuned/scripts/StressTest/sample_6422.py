...
if english_marks_premise!= english_marks_hypothesis:
    ...
    label = "contradiction"
elif mathematics_marks_premise!= mathematics_marks_hypothesis or chemistry_marks_premise!= chemistry_marks_hypothesis or biology_marks_premise!= biology_marks_hypothesis or physics_marks_premise!= physics_marks_hypothesis:
