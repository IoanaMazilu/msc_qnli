...
# the hypothesis refers to the number of each pet James has, which are also mentioned in the premise
if parrots_hypothesis <= parrots_premise:
    ...
    # check if the number of fishes, rabbits or dogs in the hypothesis contradicts the number in the premise
    label = "contradiction"
else:
