...
bananas_per_friend_premise = bananas_jesse_premise / friends_premise
if bananas_per_friend_hypothesis!= bananas_per_friend_premise:
    # check if the number of bananas each friend gets in the hypothesis contradicts the number of bananas each friend gets in the premise
    label = "contradiction"
else:
