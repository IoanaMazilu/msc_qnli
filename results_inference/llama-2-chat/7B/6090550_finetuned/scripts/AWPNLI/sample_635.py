...
# compute the total number of students that went to the concert
total_students_premise = students_premise / buses_premise

# compute the number of students that went in each bus
