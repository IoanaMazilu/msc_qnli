...
# the hypothesis mentions the score of the Mexico vs New Zealand playoff, which is also mentioned in the premise
if mexico_score_hypothesis!= mexico_score_premise:
    # check if the score of Mexico in the hypothesis contradicts the score of Mexico in the premise
    label = "contradiction"
