...
# the hypothesis talks about the ratio of Sameer and Anand's ages, referenced also in the premise
if sameer_anand_ratio_hypothesis <= sameer_anand_ratio_premise:
    ...
    # the premise gives only an estimate for the ratio of Sameer and Anand's ages
