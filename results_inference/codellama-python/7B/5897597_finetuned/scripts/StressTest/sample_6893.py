...
if cube_dimensions_hypothesis <= cube_dimensions_premise:
    # check if the hypothesis value contradicts the dimensions of the cube in the premise
    label = "contradiction"
elif cube_size_hypothesis!= cube_size_premise:
    # check if the size of the cubes in the hypothesis contradicts the size of the cubes used to make the cube in the premise
    label = "contradiction"
else:
