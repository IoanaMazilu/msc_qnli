...
if math_marks_hypothesis <= math_marks_premise:
    # check if the hypothesis value for Mathematics contradicts the value in the premise
    label = "contradiction"
    ...
    # check if the hypothesis values for other subjects contradict the values in the premise
    label = "contradiction"
else:
