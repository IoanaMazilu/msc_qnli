red_green_blue_ratio_premise = 1/3
red_green_blue_ratio_hypothesis = 4/3

# the hypothesis refers to the ratio of red, green, and blue toy bricks used by Gali to build a tower, also mentioned in the premise
