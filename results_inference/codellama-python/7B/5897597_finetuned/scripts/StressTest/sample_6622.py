...
if committee_size_hypothesis >= committee_size_premise:
    # check if the size of the committee in the hypothesis contradicts the estimate of less than 'committee_size_premise'
    label = "contradiction"
    ...
    # any size of the committee less than 'committee_size_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
