...
if dibi_score_hypothesis >= dibi_score_premise:
    # check if the hypothesis value contradicts the premise value of Dibi's score
    label = "contradiction"
elif balan_score_hypothesis!= balan_score_premise:
    # check if the hypothesis value contradicts the premise value of Balan's score
    label = "contradiction"
elif cristen_score_hypothesis!= cristen_score_premise:
    # check if the hypothesis value contradicts the premise value of Cristen's score
    label = "contradiction"
else:
