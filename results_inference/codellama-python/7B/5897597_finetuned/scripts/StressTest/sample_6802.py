...
# the hypothesis talks about the denomination of the bonds, which is also mentioned in the premise
if bond_denomination_hypothesis >= bond_denomination_premise:
    # check if the hypothesis value contradicts the premise of less than 'bond_denomination_premise'
    label = "contradiction"
else:
