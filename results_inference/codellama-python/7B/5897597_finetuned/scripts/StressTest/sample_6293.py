...
if english_marks_hypothesis >= english_marks_premise:
    # check if the estimate of 'english_marks_hypothesis' contradicts the marks obtained in English in the premise
    label = "contradiction"
    ...
    # check if the marks obtained in any of the other subjects in the hypothesis contradict the marks obtained in the same subjects in the premise
    label = "contradiction"
else:
