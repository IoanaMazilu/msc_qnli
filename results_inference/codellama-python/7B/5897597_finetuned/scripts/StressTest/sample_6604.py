...
# the hypothesis talks about the return of the investment after 'n' years, referenced also in the premise
if investment_return_hypothesis >= investment_return_premise:
    ...
    # any return of the investment less than 'investment_return_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
