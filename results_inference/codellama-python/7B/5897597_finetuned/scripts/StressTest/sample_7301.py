...
# the hypothesis refers to the number of each type of animals James owns, mentioned in the premise
if parrots_hypothesis <= parrots_premise:
    # check if the hypothesis value contradicts the number of parrots in the premise
    label = "contradiction"
