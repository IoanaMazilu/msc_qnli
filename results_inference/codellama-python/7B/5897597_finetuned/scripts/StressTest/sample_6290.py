...
if kiwi_weight_hypothesis <= kiwi_weight_premise:
    # check if the hypothesis value contradicts the weight of kiwi fruit bought in the premise
    label = "contradiction"
elif kiwi_rate_hypothesis!= kiwi_rate_premise:
    # check if the rate of kiwi fruit in the hypothesis contradicts the rate of kiwi fruit bought in the premise
    label = "contradiction"
else:
