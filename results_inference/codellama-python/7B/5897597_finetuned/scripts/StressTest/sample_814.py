...
if speed_AB_hypothesis <= speed_AB_premise:
    # check if the speed of travel from A to B in the hypothesis contradicts the premise
    label = "contradiction"
elif speed_BC_hypothesis!= speed_BC_premise:
    # check if the speed of travel from B to C in the hypothesis contradicts the premise
    label = "contradiction"
else:
