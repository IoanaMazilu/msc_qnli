...
# the premise also mentions a multiplier for the amount won from the gambling
# compute the total amount of dollars won from gambling in the premise
gamble_dollars_premise = total_dollars_premise * gamble_multiplier_premise

# add the total amount of dollars from the gambling to the total amount of dollars in the premise
total_dollars_premise += gamble_dollars_premise
