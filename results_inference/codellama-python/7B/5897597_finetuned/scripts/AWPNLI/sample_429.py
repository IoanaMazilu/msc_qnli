...
earmuffs_dec_hypothesis = 5100.0
...
earmuffs_dec_premise = earmuffs_before_dec_premise - earmuffs_dec_diff_premise
if earmuffs_dec_hypothesis!= earmuffs_dec_premise:
