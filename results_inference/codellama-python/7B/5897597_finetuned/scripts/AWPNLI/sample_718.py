...
# compute the number of people who visited on Saturday according to the premise
saturday_visitors_premise = friday_visitors_premise / 3
if saturday_visitors_hypothesis!= saturday_visitors_premise:
    # check if the number of people who visited on Saturday in the hypothesis contradicts the number of people who visited on Saturday from the premise
    label = "contradiction"
else:
