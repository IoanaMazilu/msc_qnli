...
if people_class_hypothesis!= people_class_premise:
    ...
    # any number of people in the class greater than 'people_class_premise' is consistent with the premise, but cannot be fully and explicitly entailed from the premise
    label = "neutral"
