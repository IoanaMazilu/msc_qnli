...
students_hypothesis = 3.1

# the hypothesis refers to the number of students, which are also mentioned in the premise
# compute the total number of students in the premise
total_students_premise = buses_premise * students_hypothesis
