...
# the hypothesis refers to the number of work days of both the subjects mentioned in the premise
if work_days_premise > work_days_hypothesis:
    ...
    # check if the number of work days of Rajesh in the hypothesis contradicts the number of work days reported in the premise
    label = "contradiction"
else:
