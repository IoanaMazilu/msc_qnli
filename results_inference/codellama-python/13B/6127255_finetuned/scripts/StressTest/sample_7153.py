...
# the hypothesis talks about the number of each color highlighters in Kaya's teacher's desk, referenced also in the premise
if pink_highlighters_hypothesis <= pink_highlighters_premise or yellow_highlighters_hypothesis!= yellow_highlighters_premise or blue_highlighters_hypothesis!= blue_highlighters_premise:
    # check if the hypothesis value contradicts the estimate of more than 'pink_highlighters_premise' or if the number of yellow or blue highlighters in the hypothesis contradicts the number of yellow or blue highlighters reported in the premise
    label = "contradiction"
else:
