...
# the hypothesis talks about the marks of a student in various subjects, referenced also in the premise
if geography_marks_hypothesis <= geography_marks_premise:
    # check if the marks in Geography in the hypothesis contradict the estimate of more than 'geography_marks_premise'
    label = "contradiction"
    ...
    # any marks in Geography greater than 'geography_marks_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
