...
# the hypothesis refers to the length of the history paper and the due date, both mentioned in the premise
if paper_length_hypothesis <= paper_length_premise:
    # check if the hypothesis value contradicts the exact length of the paper in the premise
    label = "contradiction"
    ...
    # the premise gives the exact length of the paper
