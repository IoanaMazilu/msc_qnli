...
if geography_marks_hypothesis >= geography_marks_premise:
    ...
    # check if the estimate of 'history_marks_hypothesis' contradicts the number of marks in history in the premise
    label = "contradiction"
elif government_marks_hypothesis >= government_marks_premise:
    # check if the estimate of 'government_marks_hypothesis' contradicts the number of marks in government in the premise
    label = "contradiction"
elif art_marks_hypothesis >= art_marks_premise:
    # check if the estimate of 'art_marks_hypothesis' contradicts the number of marks in art in the premise
    label = "contradiction"
elif computer_science_marks_hypothesis >= computer_science_marks_premise:
    # check if the estimate of 'computer_science_marks_hypothesis' contradicts the number of marks in computer science in the premise
    label = "contradiction"
else:
