...
if grapes_kg_premise <= grapes_kg_hypothesis:
    # check if the estimate of 'grapes_kg_hypothesis' contradicts the number of grape kgs in the premise
    label = "contradiction"
    ...
    # check if the number of mango kgs in the hypothesis contradicts the number of mango kgs reported in the premise
    label = "contradiction"
