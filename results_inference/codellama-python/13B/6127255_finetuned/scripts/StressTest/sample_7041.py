susan_weight_over_anna_premise = 10
susan_weight_over_anna_hypothesis = 40
...
if susan_weight_over_anna_premise > susan_weight_over_anna_hypothesis:
    # check if the estimate of'susan_weight_over_anna_hypothesis' contradicts the weight difference in the premise
    label = "contradiction"
