...
if injured_students_hypothesis > injured_students_premise:
    ...
    # if the number of injured students in the hypothesis does not contradict the number of injured students in the premise, we can infer entailment
    label = "entailment"
