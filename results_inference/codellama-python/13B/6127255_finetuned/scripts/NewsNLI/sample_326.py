...
if sailors_hurt_hypothesis!= sailors_hurt_premise:
    # check if the number of sailors hurt in the hypothesis contradicts the number of sailors hurt reported in the premise
    label = "contradiction"
elif vessels_damaged_hypothesis!= vessels_damaged_premise:
    # check if the number of vessels damaged from the hypothesis contradicts the number of vessels damaged in the premise
    label = "contradiction"
else:
