...
if total_piles_hypothesis!= total_piles_premise:
    # check if the number of candy piles in the hypothesis contradicts the number of candy piles from the premise
    label = "contradiction"
else:
