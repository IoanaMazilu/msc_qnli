 ...
 children_sat_again_hypothesis = 593.0
 ...
 children_sat_again_premise = children_test_premise - children_passed_premise
 if children_sat_again_hypothesis!= children_sat_again_premise:
