...
cards_received_premise = 13.0
total_cards_hypothesis = 96.0

# the hypothesis refers to the total number of baseball cards Mike has, which is also mentioned in the premise
# compute the total number of baseball cards Mike has in the premise
total_cards_premise = cards_mike_premise + cards_received_premise
