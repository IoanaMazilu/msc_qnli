...
# the hypothesis talks about the number of John's friends who want to ride in his new car, referenced also in the premise
if friends_hypothesis <= friends_premise:
    # check if the hypothesis value contradicts the estimate of more than 'friends_premise'
    label = "contradiction"
else:
    # the premise gives only an estimate for the number of John's friends
