...
age_start_babysitting_premise = 40
age_start_babysitting_hypothesis = 20
...
if age_start_babysitting_hypothesis >= age_start_babysitting_premise:
    # check if the hypothesis value contradicts the estimate of less than 'age_start_babysitting_premise'
    label = "contradiction"
else:
