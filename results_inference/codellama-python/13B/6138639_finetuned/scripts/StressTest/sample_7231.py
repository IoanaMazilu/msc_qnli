...
# the hypothesis talks about the amount of wheat purchased by Arun, referenced also in the premise
if wheat_purchased_hypothesis >= wheat_purchased_premise:
    ...
    # the premise gives only an estimate for the amount of wheat
