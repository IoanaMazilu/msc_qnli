...
# the hypothesis talks about the departure time of a train from Delhi, referenced also in the premise
if departure_time_hypothesis <= departure_time_premise:
    # check if the hypothesis value contradicts the estimate of more than 'departure_time_premise'
    label = "contradiction"
else:
