...
# the hypothesis talks about the number of boys in different ages, referenced also in the premise
if boys_age_14_hypothesis <= boys_age_14_premise:
    ...
    # any number of boys greater than 'boys_age_14_premise' is consistent with the premise, but cannot be explicitly entailed from the premise
    label = "neutral"
