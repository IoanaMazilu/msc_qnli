...
drive_time_1_hypothesis = 1
drive_speed_1_premise = 44
drive_speed_1_hypothesis = 44
...
if drive_time_1_hypothesis >= drive_time_1_premise:
    # check if the estimate of 'drive_time_1_hypothesis' contradicts the driving time in the premise
    label = "contradiction"
elif drive_speed_1_hypothesis!= drive_speed_1_premise:
    # check if the driving speed in the hypothesis contradicts the driving speed reported in the premise
    label = "contradiction"
elif drive_time_2_hypothesis!= drive_time_2_premise:
    # check if the driving time in the hypothesis contradicts the driving time reported in the premise
    label = "contradiction"
elif drive_speed_2_hypothesis!= drive_speed_2_premise:
    # check if the driving speed in the hypothesis contradicts the driving speed reported in the premise
    label = "contradiction"
else:
