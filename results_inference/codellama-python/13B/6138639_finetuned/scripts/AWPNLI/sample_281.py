total_carrots_picked_premise = 48.0
carrots_thrown_away_premise = 11.0
...
total_carrots_premise = total_carrots_picked_premise - carrots_thrown_away_premise + carrots_picked_next_day_premise
