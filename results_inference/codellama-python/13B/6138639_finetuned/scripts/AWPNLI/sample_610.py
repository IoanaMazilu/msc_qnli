money_premise = 73.0
sold_pet_snake_premise = 55.0
total_money_hypothesis = 128.0

# the hypothesis refers to the total money Gary has, which is also mentioned in the premise
# compute the total money Gary has in the premise
total_money_premise = money_premise - sold_pet_snake_premise
