...
given_away_more_books_premise = 3.0
...
# compute the number of remaining coloring books in the premise
remaining_books_premise = bought_books_premise - given_away_books_premise - given_away_more_books_premise
